...
namespace NetCoreHomework.Migrations
{
    ...
    [Migration("20200522023743_testColumn2")]
    partial class testColumn2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetCoreHomework.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("NetCoreHomework.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NetCoreHomework.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DepartmentID")
            ...
            modelBuilder.Entity("NetCoreHomework.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("NetCoreHomework.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NetCoreHomework.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("NetCoreHomework.Models.Course", b =>
                {
                    b.HasOne("NetCoreHomework.Models.Department", "Department")
                        .WithMany("Course")
            ...
            modelBuilder.Entity("NetCoreHomework.Models.CourseInstructor", b =>
                {
                    b.HasOne("NetCoreHomework.Models.Course", "Course")
                    ...
                    b.HasOne("NetCoreHomework.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("NetCoreHomework.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("NetCoreHomework.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("NetCoreHomework.Models.OfficeAssignment", b =>
                {
                    b.HasOne("NetCoreHomework.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("NetCoreHomework.Models.OfficeAssignment", "InstructorId")
